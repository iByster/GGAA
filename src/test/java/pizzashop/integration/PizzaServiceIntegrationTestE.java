...
class PizzaServiceIntegrationTestE {
    @Test
    ...
    void testMenuRepository() {
        ...
        MenuDataModel testMenu = new MenuDataModel("Margherita", 0, 8.00d);

        MenuDataModel actualMenu = menuRepository.getMenuItem("Margherita,8.00");

        assertEquals(actualMenu.getQuantity(), testMenu.getQuantity());
        assertEquals(actualMenu.getMenuItem(), testMenu.getMenuItem());
        assertEquals(actualMenu.getPrice(), testMenu.getPrice());
    }
